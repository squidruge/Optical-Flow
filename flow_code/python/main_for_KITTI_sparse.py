...
# get paths
pic_num = 130
path = "C:\\dataset\\KITTI\\dense_flow\\training"
original_img_path = path + f"\\image_2\\000{pic_num:03}_10.png"
optical_flow_path = path + f"\\flow_noc\\000{pic_num:03}_10.png"
semantic_path = path + f"\\semantic\\0000000{pic_num:03}_10.png"
...
# # plt.figure("semantic img")
# # plt.imshow(semantic_img)
# # plt.axis('off')
# # plt.show()
# # road: (36, 28, 236)
# mask = cv2.inRange(semantic_img, (36, 28, 236), (36, 28, 236))
# mask = mask / 255
# mask.astype(int)
# plt.figure("mask")
# plt.imshow(mask)
...
print(f"popt[0]:{popt[0]}, popt[1]:{popt[1]}")
